...
public class ParameterizedTypeImpl implements ParameterizedType {
    ...
    private void validateConstructorArguments() {
        ...
        if (need != actual) {
            throw new RuntimeException("泛型个数不对等：--需要的：" + need + " 个，--实际的：" + actual + "个");
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ParameterizedType) {
            ...
            if (this == parameterizedType) {
                ...
                return Objects.equals(this.ownerType, typeOwnerType) && Objects.equals(this.rawType, typeRawType) && Arrays.equals(this.actualTypeArguments, parameterizedType.getActualTypeArguments());
            }
        } else {
            return false;
        }
    ...
    public String toString() {
        ...
        if (this.ownerType != null) {
            ...
            if (this.ownerType instanceof ParameterizedTypeImpl) {
                builder.append(this.rawType.getName().replace(((ParameterizedTypeImpl) this.ownerType).rawType.getName() + "$", ""));
            } else {
